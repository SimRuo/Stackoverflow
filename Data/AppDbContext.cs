...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_Badges_Id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_LinkTypes_Id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_PostLinks_Id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_PostTypes_Id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_Votes_Id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_VoteType_Id");
